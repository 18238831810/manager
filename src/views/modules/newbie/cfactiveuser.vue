<template>
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-newbie__cfactiveuser}">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        ...
        <!--
        <el-form-item>
          <el-button v-if="$hasPermission('newbie:cfactiveuser:save')" type="primary" @click="addOrUpdateHandle()">{{ $t('add') }}</el-button>
        </el-form-item>
        <el-form-item>
          <el-button v-if="$hasPermission('newbie:cfactiveuser:delete')" type="danger" @click="deleteHandle()">{{ $t('deleteBatch') }}</el-button>
        </el-form-item>
        -->
      </el-form>
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%;">
        ...
        <el-table-column prop="chineseName" label="客户姓名" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column prop="updatedDate" label="更新时间" header-align="center" align="center"></el-table-column>
        <el-table-column prop="updatedUser" label="更新人" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('newbie:cfactiveuser:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">{{ $t('update') }}</el-button>
            <el-button v-if="$hasPermission('newbie:cfactiveuser:delete')" type="text" size="small" @click="deleteHandle(scope.row.id)">{{ $t('delete') }}</el-button>
          </template>
        </el-table-column>
        -->
      </el-table>
...
import AddOrUpdate from './cfactiveuser-add-or-update'
export default {
  mixins: [mixinViewModule],
  data () {
    return {
      mixinViewModuleOptions: {
        getDataListURL: '/newbie/cfactiveuser/page',
        getDataListIsPage: true,
        deleteURL: '/newbie/cfactiveuser',
        deleteIsBatch: true
      },
      startTime: '',
      endTime: '',
